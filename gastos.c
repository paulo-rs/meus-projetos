...
=====================
#ARRUMAR MENU
#inclui campos COD,ITEM,TIPO,VALOR,DATA
#TOTALIZAR POR TIPO DESPESA,RECEITA E MOSTRAR SALDO
#LISTAR FORMATO TABELA
#DELETAR POR CODIGO
#SALVAR/CARREGAR DISCO
ALTERAR ITEMS
MOSTRAR POR CATEGORIA TIPO= RECEITAS OU DESPESAS
